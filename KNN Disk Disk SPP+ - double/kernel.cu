...
int main(int argc, char* argv[])
{
	...
	std::unique_ptr<thrust::device_vector<point_struct>[]> d_query_data(new thrust::device_vector<point_struct>[NUM_STREAMS]);				// Query points Device Vector, copies data from Host Vector
